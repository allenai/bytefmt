...
func TestFormat(t *testing.T) {
	tests := []struct {
		...
		// Minimum value representable by int64: -2**62
		{In: New(math.MinInt64, Metric), Expect: "-9.223 EB"},
		{In: New(math.MinInt64, Binary), Expect: "-8 EiB"},

		// Maximum value representable by int64: 2**63-1
		{In: New(math.MaxInt64, Metric), Expect: "9.223 EB"},
		{In: New(math.MaxInt64, Binary), Expect: "8 EiB"},
		...
		// Loss of precision.
		{In: New(1001*Byte, Metric), Expect: "1.001 kB"},
		{In: New(1025*Byte, Binary), Expect: "1.001 KiB"},
		{In: New(123456*Byte, Metric), Expect: "123.5 kB"},
		{In: New(123456*Byte, Binary), Expect: "120.6 KiB"},
		{In: New(1500*Byte, Metric), Expect: "1.5 kB"},
		{In: New(1501*Byte, Metric), Expect: "1.501 kB"},
		{In: New(1499*Byte, Metric), Expect: "1.499 kB"},

		// Rounding with Metric suffixes.
		{In: New(14995*Byte, Metric), Expect: "14.99 kB"},
		{In: New(14996*Byte, Metric), Expect: "15 kB"},
		{In: New(15000*Byte, Metric), Expect: "15 kB"},
		{In: New(15004*Byte, Metric), Expect: "15 kB"},
		{In: New(15005*Byte, Metric), Expect: "15.01 kB"},

		// Rounding with Binary suffixes.
		{In: New(16378*Byte, Binary), Expect: "15.99 KiB"},
		{In: New(16379*Byte, Binary), Expect: "16 KiB"},
		{In: New(16384*Byte, Binary), Expect: "16 KiB"},
		{In: New(16389*Byte, Binary), Expect: "16 KiB"},
		{In: New(16390*Byte, Binary), Expect: "16.01 KiB"},

		// 4 significant figures with Metric suffixes.
		{In: New(1*Byte, Metric), Expect: "1 B"},
		{In: New(11*Byte, Metric), Expect: "11 B"},
		{In: New(111*Byte, Metric), Expect: "111 B"},
		{In: New(1111*Byte, Metric), Expect: "1.111 kB"},
		{In: New(11111*Byte, Metric), Expect: "11.11 kB"},
		{In: New(111111*Byte, Metric), Expect: "111.1 kB"},
		{In: New(1111111*Byte, Metric), Expect: "1.111 MB"},
		{In: New(11111111*Byte, Metric), Expect: "11.11 MB"},
		{In: New(111111111*Byte, Metric), Expect: "111.1 MB"},
		{In: New(1111111111*Byte, Metric), Expect: "1.111 GB"},
		{In: New(11111111111*Byte, Metric), Expect: "11.11 GB"},
		{In: New(111111111111*Byte, Metric), Expect: "111.1 GB"},
		{In: New(1111111111111*Byte, Metric), Expect: "1.111 TB"},
		{In: New(11111111111111*Byte, Metric), Expect: "11.11 TB"},
		{In: New(111111111111111*Byte, Metric), Expect: "111.1 TB"},
		{In: New(1111111111111111*Byte, Metric), Expect: "1.111 PB"},
		{In: New(11111111111111111*Byte, Metric), Expect: "11.11 PB"},
		{In: New(111111111111111111*Byte, Metric), Expect: "111.1 PB"},
		{In: New(1111111111111111111*Byte, Metric), Expect: "1.111 EB"},

		// 4 significant figures with Binary suffixes.
		{In: New(1*Byte, Binary), Expect: "1 B"},
		{In: New(11*Byte, Binary), Expect: "11 B"},
		{In: New(111*Byte, Binary), Expect: "111 B"},
		{In: New(1111*Byte, Binary), Expect: "1.085 KiB"},
		{In: New(11111*Byte, Binary), Expect: "10.85 KiB"},
		{In: New(111111*Byte, Binary), Expect: "108.5 KiB"},
		{In: New(1111111*Byte, Binary), Expect: "1.06 MiB"},
		{In: New(11111111*Byte, Binary), Expect: "10.6 MiB"},
		{In: New(111111111*Byte, Binary), Expect: "106 MiB"},
		{In: New(1111111111*Byte, Binary), Expect: "1.035 GiB"},
		{In: New(11111111111*Byte, Binary), Expect: "10.35 GiB"},
		{In: New(111111111111*Byte, Binary), Expect: "103.5 GiB"},
		{In: New(1111111111111*Byte, Binary), Expect: "1.011 TiB"},
		{In: New(11111111111111*Byte, Binary), Expect: "10.11 TiB"},
		{In: New(111111111111111*Byte, Binary), Expect: "101.1 TiB"},
		{In: New(1111111111111111*Byte, Binary), Expect: "1011 TiB"},
		{In: New(11111111111111111*Byte, Binary), Expect: "9.869 PiB"},
		{In: New(111111111111111111*Byte, Binary), Expect: "98.69 PiB"},
		{In: New(1111111111111111111*Byte, Binary), Expect: "986.9 PiB"},
	}
